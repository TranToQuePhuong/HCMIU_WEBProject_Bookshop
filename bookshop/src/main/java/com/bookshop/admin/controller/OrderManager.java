...
public class OrderManager {
	...
	public String create(RedirectAttributes model,
			@ModelAttribute("entity") Order entity /*lấy model entity từ _form.jsp*/) {
		dao.create(entity);
		model.addAttribute("message", "Add order successfully !");
		//Không để "admin/order/index" vì dữ liệu thêm xong vẫn còn nằm trên form
