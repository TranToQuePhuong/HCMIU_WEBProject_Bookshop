		...
		<form:form action="${base}/index" modelAttribute="entity" enctype="multipart/form-data">
			<div class="row">
				<div class="form-group col-sm-6">
					...
					<!-- readonly = true -->
					<!-- ${empty entity.id}=true => rỗng -->
					<!-- mà mình cần readonly khi khác rỗng, rỗng vẫn cho nhập -->
			...
			<div class="row">
				...
				<div class="form-group col-sm-6">
					...
					<div class="form-control">
						<form:radiobutton path="available" value="true" label="A" />
						<form:radiobutton path="available" value="false" label="User" />
					</div>
				</div>
			</div>
			<div class="row">
				<div class="form-group col-sm-6">
					...
					<form:select path="category.id" class="form-control">
						<form:options items="${cates}" itemLabel="name" itemValue="id"></form:options>
					</form:select>
				</div>
